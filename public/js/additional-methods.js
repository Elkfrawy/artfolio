...
(function (factory) {
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) || /^(0?[1-9]|[12]\d|3[01])[\.\/\-](0?[1-9]|1[012])[\.\/\-]([12]\d)?(\d\d)$/.test(value)
      );
    },
    $.validator.messages.date
  );
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return this.optional(element) || (/^[a-z\-.,()'"\s]+$/i.test(value) && /^[A-Za-z]/i.test(value));
    },
    'Letters or punctuation only please (start with letter)'
  );
  ...
  $.validator.addMethod(
    ...
    function (value, element, options) {
      var isDefault = typeof options === 'undefined',
        ...
        includeTerritories =
          isDefault || typeof options.includeTerritories === 'undefined' ? false : options.includeTerritories,
